    ...
    return Card(
      child: InkWell(
        ...
        child: Padding(
          ...
          child: DesignPatternCardContent(
            pattern: pattern,
...
class DesignPatternCardContent extends StatelessWidget {
  const DesignPatternCardContent({
    required this.pattern,
    this.primaryColor,
    super.key,
  });
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          spacing: 10,
          children: [
            Icon(Icons.bar_chart_rounded, size: 16, color: colors.outline),
            Expanded(
              child: Text(
